	...
	<div class="row">
		<div class="col-lg-8">
			<div class="box box-default">
				...
				<form action="<?=site_url('admin/master/kategoriberita/simpan/')?>" method="post" class="form-wajib">
					<div class="box-body">
						<div class="form-group">
							<label>Kategori Berita</label>
							<div>
								<input autocomplete="false" type="text" class="form-control" name="kategori" placeholder="Masukan Kategori Berita">
							</div>
						</div>
					</div>

	...
	<div class="row">
		<div class="col-lg-8">
			<div class="box box-default">
				...
				<form action="<?=site_url('admin/master/berita/edit/'.$berita_id)?>" method="post" class="form-wajib">
					<div class="box-body">
						<div class="form-group">
							<label>Judul Berita</label>
							<div>
								<input value="<?=$berita->judul_berita?>" autocomplete="false" type="text" required class="form-control" name="judul_berita" placeholder="Masukan Judul Berita">
							</div>
						</div>
						<div class="form-group">
							...
							<div>
								<select name="kategori_id" class="form-control select2">
									...
									<?php  foreach ($kategori->result() as $row) :  ?>
										...
										<option <?php echo $berita->kategori_id == $row->kategori_id ? 'selected' : '' ?>  value="<?=$row->kategori_id?>"><?=$row->kategori?></option>
